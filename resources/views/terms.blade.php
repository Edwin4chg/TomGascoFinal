                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h2 class="section-heading text-center">Términos y Condiciones</h2>
                            <p class="text-muted text-center">
                                Bienvenido a los términos y condiciones de Tom Gasco. Por favor, lea detenidamente antes de utilizar nuestro sitio web.
                            </p>
                            <!-- Agrega aquí los términos y condiciones específicos de tu sitio -->
                            <p>
                            Al acceder y utilizar este sitio web, aceptas cumplir con estos términos y condiciones. No deberás utilizar este sitio con fines ilegales ni violar ninguna ley aplicable. Nos reservamos el derecho de suspender o dar por terminado tu acceso si determinamos que estás utilizando el sitio de manera inapropiada.
                            </p>
                            <p>
                            Nos comprometemos a proteger tu privacidad en línea. La información que nos proporcionas se utilizará de acuerdo con nuestra política de privacidad. Implementamos medidas de seguridad para garantizar la protección de tus datos, pero no podemos garantizar la seguridad absoluta. Al utilizar nuestro sitio, aceptas los términos de nuestra política de privacidad y reconoces los riesgos asociados con la transmisión de información en línea.
                            </p>
                            <!-- Fin de los términos y condiciones -->
                            <p class="text-muted text-center">
                                Gracias por revisar nuestros términos y condiciones. Si tienes alguna pregunta, no dudes en contactarnos.
                            </p>
                        </div>
                    </div>
                </div>
