...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0" id="intro">
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
        ...
        <div class="offcanvas-body">
            <div id="cart-container" class="list-group mb-3">
                ...
                <a class="w-100 btn btn-primary btn-lg mb-1" href="{{ url('/tcheckout') }}">Ir a Pagar</a>
            </div>
        </div>
    </div>
        ...
        <div class="container-lg">
            ...
            <div class="list-group mb-3">
                ...
                <div class="list-group-item border-0 d-flex justify-content-between lh-sm">
                    <div class="d-flex align-items-center">
                        <div class="image-holder text-center p-3 me-3 border rounded-4">
                            <img src="{{ asset('storage/' . $cartSong->song_photo) }}" alt="{{ $cartSong->song_title }}" class="img-fluid" style="width: 80px; height: 80px; object-fit: cover; border-radius: 7px;">
                        </div>
                        <div>
                            <h6 class="my-0">{{ $cartSong->song_title }}</h6>
                            <small class="text-body-secondary">{{ $cartSong->song_description }}</small>
                ...
                <li class="list-group-item border-0 d-flex justify-content-end">
                    ...
                    <strong class="ms-3 me-5 fs-3">${{ $cartSongs->sum('price') }}</strong>
                </li>
            ...
            <div class="text-center mt-4">
                <a class="btn btn-primary btn-lg" href="{{ url('/store') }}"> Ver Tienda</a>
                <a class="btn btn-danger btn-lg" href="{{ url('/cart/empty') }}"> Vaciar Carrito</a>
                <!-- Enlazar al método correcto en CheckoutController -->
                <a class="btn btn-primary btn-lg" href="{{ route('tcheckout') }}">Ir a Pagar</a>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=CLIENT_ID" async>
    </script>
</body>
