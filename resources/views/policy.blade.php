            ...
            <nav class="navbar navbar-expand-lg" aria-label="Offcanvas navbar large">
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
                    ...
                    <ul class="navbar-nav ms-5 flex-grow-1 pe-3">
                        ...
                        <li class="nav-item ms-3">
                        <a class="nav-link text-dark" href="about.html">Sobre Nosotros</a>
                        </li>
                        <li class="nav-item ms-3 dropdown">
                        <a class="nav-link text-dark" href="{{ url('/store') }}"> Tienda</a>
                        </li>
                        <li class="nav-item ms-3 dropdown">
                        <a class="nav-link text-dark dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Pages </a>
                        <ul class="dropdown-menu">
                            <li>
                            <a href="checkout.html" class="dropdown-item item-anchor">Carrito <span class="badge bg-primary fs-6">PRO</span></a>
                            </li>                                       
                        </ul>
                        </li>
                    </ul>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h2 class="section-heading text-center">Política de Privacidad</h2>
                            <p class="text-muted text-center">
                                Bienvenido a la política de privacidad de Tom Gasco, donde tu seguridad y confianza son nuestra máxima prioridad.
                            </p>
                            <p>
                                En Tom Gasco, nos comprometemos a proteger tu privacidad en línea. Esta política describe cómo recopilamos, utilizamos y protegemos la información que proporcionas al utilizar nuestro sitio web. Queremos que estés informado sobre nuestras prácticas de privacidad para que puedas tomar decisiones informadas sobre el uso de nuestros servicios.
                            </p>
                            <p>
                                Recopilamos información limitada y necesaria para brindarte una experiencia personalizada y segura. Esta información puede incluir datos de contacto, preferencias de música y detalles de la transacción. Nunca compartiremos tus datos con terceros sin tu consentimiento expreso.
                            </p>
                            <p>
                                Utilizamos medidas de seguridad avanzadas para proteger tus datos contra accesos no autorizados. Además, ofrecemos opciones para que puedas controlar la información que compartes con nosotros.
                            </p>
                            <p>
                                Al utilizar nuestro sitio, aceptas los términos y prácticas descritos en esta política de privacidad. Te alentamos a revisar esta política regularmente, ya que puede estar sujeta a cambios para reflejar mejoras en nuestras prácticas de privacidad.
                            </p>
                            <p class="text-muted text-center">
                                Gracias por confiar en Tom Gasco para tu experiencia musical. Tu privacidad es fundamental para nosotros.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="menu-list list-unstyled">
                        ...
                        <li class="menu-item pb-2">
                        <a href="about.html" class="item-anchor">Sobre Nosotros</a>
                        </li>
                        <li class="menu-item pb-2">
                        <a href="shop-with-sidebar.html" class="item-anchor">Tienda</a>
                        </li>
                        <li class="menu-item pb-2">
                        <a href="contact.html" class="item-anchor">Contactanos</a>
                        </li>
                    </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="social-links">
                        <ul class="list-unstyled">
                        <li class="fw-medium pb-2"> <a href="tel:+51912345789">+51 912 345 789</a></li>
                        <li class="fw-medium pb-2">
