    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasLogin" aria-labelledby="My Login">
        ...
        <div class="offcanvas-body">
            <div class="login-detail">
                ...
                <div class="welcome-message">
                    ...
                    <a href="//www.aliexpress.com/p/order/index.html?spm=a2g0o.cart.headerAcount.2.5c177a9dAYsjo9" data-spm-anchor-id="a2g0o.cart.headerAcount.2">
                        <span class="comet-icon comet-icon-orders my-account--icon--16yzkFW">
                            <!-- Cambié la etiqueta svg por la etiqueta img que muestra la imagen -->
                ...
                <div class="welcome-message">
                    <p>Bienvenido, {{ Session::get('google_user')['name'] }}!</p>
                    <!-- ... Resto de tu código ... -->
                </div>
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item border-0 d-flex justify-content-between lh-sm">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a class="btn btn-danger btn-lg ms-3" href="{{ route('cart.remove', ['cartItemId' => $cartSong->id]) }}">X</a>
                        </div>
                    </li>
                    @empty
    ...
    <section id="featured-product" class="py-lg-6 bg-light position-relative">
        <div class="container-lg">
            <div class="row row-cols-1 row-cols-md-4 g-4">
                ...
                <div class="col">
                    <div class="product-item">
                        ...
                        <div class="product-info ps-2">
                            <h3 class="m-0">
                                <a href="#" class="text-secondary" data-bs-toggle="modal" data-bs-target="#productModal{{ $song->id }}">
                                    {{ $song->title }}
                                </a>
                            </h3>
                ...
                <!-- Modal -->
                <div class="modal fade" id="productModal{{ $song->id }}" tabindex="-1" aria-labelledby="productModalLabel{{ $song->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="productModalLabel{{ $song->id }}">{{ $song->title }}</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <div class="text-center">
                                    <img src="{{ asset('storage/' . $song->photo) }}" alt="{{ $song->title }}" class="img-fluid" style="max-width: 80%; height: auto; border-radius: 1rem;">

                                    <p style="color: Black; font-size: 1.3rem; margin-top: 1rem;">{{ $song->description }}</p>
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <a href="#" class="btn btn-outline-gray text-capitalize rounded-pill mt-4 btn-sm add-to-cart" data-product-id="{{ $song->id }}" style="background-color: dimgray; color: white;">
                                        Comprar
                                        <svg class="cart" width="18" height="18">
                                            <use xlink:href="#cart"></use>
                                        </svg>
