                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h2 class="section-heading text-center">Sobre Nosotros</h2>
                            <p class="text-muted text-center">
                                Bienvenido a la historia de Tom Gasco, un viaje apasionante a través de la música y la creatividad. Nuestra misión es llevar la música a tus oídos de una manera única y significativa.
                            </p>                            
                            <img src="{{ asset('/img/gasco.jpg') }}" alt="" style="width: 50%;  border-radius: 1rem; margin-left: 25%; margin-right: 25%; margin-bottom: 2rem;">
                            <p>
                                En Tom Gasco, creemos que la música tiene el poder de inspirar, conectar y transformar. Desde nuestros humildes comienzos en Perú, hemos crecido hasta convertirnos en un referente en la industria musical. Cada canción, cada melodía cuenta una historia, y estamos aquí para compartir esas historias contigo.
                            </p>
                            <p>
                                Nuestra tienda no es solo un lugar para comprar música; es un espacio donde los amantes de la música pueden sumergirse en un mundo de sonidos, explorar nuevos géneros y descubrir artistas increíbles. Nos enorgullece ofrecer una selección cuidadosamente curada que abarca desde clásicos atemporales hasta los últimos éxitos.
                            </p>
                            <p>
                                Además de ser una tienda, somos una comunidad de apasionados por la música. Nos encantaría que te unieras a nosotros en este viaje. Explora, descubre y déjate llevar por la magia de la música con Tom Gasco.
                            </p>
                            <p class="text-muted text-center">
                                ¡Gracias por ser parte de nuestra historia musical!
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="menu-list list-unstyled">
                        ...
                        <li class="menu-item pb-2">
                        <a href="#intro"class="item-anchor">Sobre Nosotros</a>
                        </li>
                        <li class="menu-item pb-2">
