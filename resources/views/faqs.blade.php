                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <h2 class="section-heading text-center">Preguntas Frecuentes</h2>
                            <p class="text-muted text-center">
                                Encuentra respuestas a las preguntas más frecuentes sobre Tom Gasco. Si no encuentras lo que buscas, no dudes en contactarnos.
                            </p>
                            <!-- Pregunta 1 -->
                            <div class="accordion" id="accordionQuestion1">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingQuestion1">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseQuestion1" aria-expanded="false" aria-controls="collapseQuestion1">
                                            ¿Cómo creo una cuenta en Tom Gasco?
                                        </button>
                                    </h2>
                                    <div id="collapseQuestion1" class="accordion-collapse collapse" aria-labelledby="headingQuestion1" data-bs-parent="#accordionQuestion1">
                                        <div class="accordion-body">
                                            Para crear una cuenta en Tom Gasco, simplemente haz clic en el botón "Registrarse" en la esquina superior derecha de la página y sigue las instrucciones. Proporciona la información requerida y ¡listo!
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Pregunta 2 -->
                            <div class="accordion" id="accordionQuestion2">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingQuestion2">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseQuestion2" aria-expanded="false" aria-controls="collapseQuestion2">
                                            ¿Cómo puedo realizar un pedido?
                                        </button>
                                    </h2>
                                    <div id="collapseQuestion2" class="accordion-collapse collapse" aria-labelledby="headingQuestion2" data-bs-parent="#accordionQuestion2">
                                        <div class="accordion-body">
                                            Realizar un pedido en Tom Gasco es fácil. Navega por nuestra tienda, selecciona los productos que te gustan, agrégelos al carrito y sigue el proceso de pago.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Pregunta 3 -->
                            <!-- Añade más preguntas con la misma estructura -->
                            ...
                            <p class="text-muted text-center">
                                ¿Tienes más preguntas? No dudes en <a href="contact.html">contactarnos</a>.
                            </p>
                        </div>
                    </div>
                </div>
