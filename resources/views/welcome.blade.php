...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
    ...
    <div class="offcanvas-body">
      <div class="login-detail">
        ...
        <div class="welcome-message">
          ...
          <a href="{{ route('home') }}" data-spm-anchor-id="a2g0o.cart.headerAcount.2">
              ...
              <div class="row">
                <div class="col-lg-7">
                  <div class="image-holder mb-lg-0 mb-md-2">
                    <img src="{{ asset('img/banner-image3.jpg') }}" alt="product" class="img-fluid rounded-4">
                  </div>
                </div>
                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                  <div class="banner-content w-100 h-100 position-relative bg-light border rounded-4 mx-auto d-flex align-items-center">
                    <div class="col-lg-9 col-md-6 col-sm-8 text-center mx-auto py-lg-6">
                      <h1 class="display-2">Tom Gasco<span class="display-4 text-secondary d-block"> Tom Gasco </span>
                      </h1>
                      <p>En la sinfonía de la música electrónica, cada beat es un latido que conecta las almas, transformando la pista en un viaje donde las emociones bailan al ritmo de la electrónica universal.</p>
                      <div class="btn-center mt-4">
                        <a href="{{ url('/store') }}" class="btn btn-primary btn-md text-uppercase rounded-0">Ver las canciones</a>
                      </div>
                    </div>
                    <div class="bg-pattern-overlay position-absolute">
                      <img src="{{ asset('img/pattern-overlay1.png') }}" alt="pattern" class="img-fluid">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="swiper-slide">
            <div class="banner-item d-flex text-center align-items-center">
              <div class="row">
                <div class="col-lg-7">
                  <div class="image-holder mb-lg-0 mb-md-2">
                    <img src="{{ asset('storage/' . $latestSong1->photo) }}" alt="Song Photo" class="img-fluid rounded-4">
                  </div>
                </div>
                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                  <div class="banner-content w-100 h-100 position-relative bg-light border rounded-4 mx-auto d-flex align-items-center">
                    <div class="col-lg-9 col-md-6 col-sm-8 text-center mx-auto py-lg-6">
                      <h1 class="display-2">Cancion: <span class="display-4 text-secondary">{{ $latestSong1->title }}</span></h1>
                      <p>{{ $latestSong1->description }}</p>
                      <div class="btn-center mt-4">
                        <a href="shop-with-sidebar.html" class="btn btn-primary btn-md text-uppercase rounded-0">Compralo ahora</a>
                      </div>
                    </div>
                    <div class="bg-pattern-overlay position-absolute">
                      <img src="{{ asset('img/pattern-overlay1.png') }}" alt="pattern" class="img-fluid">
          ...
          <div class="swiper-slide">
            <div class="banner-item d-flex text-center align-items-center">
              <div class="row">
                <div class="col-lg-7">
                  <div class="image-holder mb-lg-0 mb-md-2">
                    <img src="{{ asset('storage/' . $latestSong2->photo) }}" alt="Song Photo" class="img-fluid rounded-4">
                  </div>
                </div>
                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                  <div class="banner-content w-100 h-100 position-relative bg-light border rounded-4 mx-auto d-flex align-items-center">
                    <div class="col-lg-9 col-md-6 col-sm-8 text-center mx-auto py-lg-6">
                      <h1 class="display-2">Cancion: <span class="display-4 text-secondary">{{ $latestSong2->title }}</span></h1>
                      <p>{{ $latestSong2->description }}</p>
                      <div class="btn-center mt-4">
                        <a href="shop-with-sidebar.html" class="btn btn-primary btn-md text-uppercase rounded-0">Compralo Ahora</a>
                      </div>
                    </div>
          ...
          <div class="swiper-slide">
            <div class="banner-item d-flex text-center align-items-center">
              <div class="row">
                <div class="col-lg-7">
                  <div class="image-holder mb-lg-0 mb-md-2">
                    <img src="{{ asset('storage/' . $latestSong3->photo) }}" alt="Song Photo" class="img-fluid rounded-4">
                  </div>
                </div>
                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                  <div class="banner-content w-100 h-100 position-relative bg-light border rounded-4 mx-auto d-flex align-items-center">
                    <div class="col-lg-9 col-md-6 col-sm-8 text-center mx-auto py-lg-6">
                      <h1 class="display-2">Cancion: <span class="display-4 text-secondary">{{ $latestSong3->title }}</span></h1>
                      <p>{{ $latestSong3->description }}</p>
                      <div class="btn-center mt-4">
                        <a href="shop-with-sidebar.html" class="btn btn-primary btn-md text-uppercase rounded-0">Compralo Ahora</a>
                      </div>
                    </div>
    ...
    <div class="container-lg">
      <div class="row justify-content-center">
        <div class="display-header text-center position-relative">
          <h2 class="display-2">Categorias</h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="image-holder position-relative">
            <img src="{{ asset('img/cate-item1.jpeg') }}" alt="dress" class="img-fluid rounded-4">
            <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
              <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">
                {{ $artist1->artist ?? 'Compra Ahora' }}
              </a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="image-holder position-relative">
            <img src="{{ asset('img/cate-item2.png') }}" alt="dress" class="img-fluid rounded-4">
            <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
              <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">
                {{ $artist2->artist ?? 'Compra Ahora' }}
              </a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="image-holder position-relative">
            <img src="{{ asset('img/cate-item3 (1).jpg') }}" alt="dress" class="img-fluid rounded-4">
            <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
              <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">
                {{ $artist3->artist ?? 'Compra Ahora' }}
              </a>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 mb-4">
          <div class="image-holder position-relative">
            <img src="{{ asset('img/cate-item4 (1).jpg') }}" alt="dress" class="img-fluid rounded-4">
            <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
              <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">
                {{ $artist4->artist ?? 'Compra Ahora' }}
              </a>
            </div>
          </div>
        </div>
  ...
  <section id="featured-product" class="py-lg-6 bg-light position-relative">
    <div class="container-lg">
      <div class="display-header text-center position-relative">
        <h2 class="display-2 mt-0">Lo Último</h2>
      </div>
      <div class="swiper product-swiper">
        <div class="swiper-wrapper">
          @foreach($featuredSongs as $song)
          <div class="swiper-slide" data-product-id="{{ $song->id }}">
            <div class="product-item">
              <div class="image-holder text-center p-3 mb-4 border rounded-4">
                <img src="{{ asset('storage/' . $song->photo) }}" alt="toy" class="img-fluid" style="width: 250px; height: 250px; object-fit: cover; border-top-left-radius: 7px; border-top-right-radius: 7px;">
              </div>
              <div class="product-info ps-2">
                <h3 class="m-0">
                  <a href="single-product.html" class="text-secondary">{{ $song->title }}</a>
                </h3>
                <div class="product-price text-primary">${{ $song->price }}</div>
                <div class="d-flex align-items-center mt-2">
                  <a href="{{ Auth::check() ? route('addToCart', ['songId' => $song->id]) : route('login') }}" class="btn btn-outline-gray text-capitalize rounded-pill mt-4 btn-sm add-to-cart" style="background-color: dimgray; color: white;">
                    Comprar
                    <svg class="cart" width="18" height="18">
                      <use xlink:href="#cart"></use>
                    </svg>
  ...
  <!-- NewsLetter -->
  <section id="newsletter" class="position-relative py-lg-8 bg-linear">
    <div class="container">
      <div class="row justify-content-center">
        <div class="display-header text-center position-relative">
          <h2 class="display-2">Mantente al día</h2>
        </div>
            ...
            <div id="mc_embed_signup">
              <form action="https://edwin4chg.us11.list-manage.com/subscribe/post?u=ce4ebaff0a9c915dd1ecd440c&amp;id=c05ae49dec&amp;f_id=00e29ae0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
                <div id="mc_embed_signup_scroll">
                  <h2>Suscríbase para recibir correos electrónicos sobre nuevos lanzamientos y actualizaciones.</h2>
  ...
  <section id="new-arrival" class="py-lg-6 my-lg-8 mb-lg-0 bg-light position-relative">
    <div class="container-lg">
      <div class="display-header text-center position-relative">
        <h2 class="display-2">Recien Añadidos</h2>
      </div>
      <div class="swiper product-swiper">
        <div class="swiper-wrapper">
          @foreach($oldSongs as $older)
          <div class="swiper-slide">
            <div class="product-item">
              <div class="image-holder text-center p-3 mb-4 border rounded-4">
                <img src="{{ asset('storage/' . $older->photo) }}" alt="toy" class="img-fluid">
              </div>
              <div class="product-info ps-2">
                <h3 class="m-0">
                  <a href="single-product.html" class="text-secondary">{{ $older->title }}</a>
                </h3>
                <div class="product-price text-primary">${{ $older->price }}</div>
                <a href="{{ route('addToCart', ['songId' => $song->id]) }}" class="btn btn-outline-gray text-capitalize rounded-pill mt-4 btn-sm add-to-cart" style="background-color: dimgray; color: white;">
                  Comprar
                  <svg class="cart" width="18" height="18">
                    <use xlink:href="#cart"></use>
                  </svg>
  ...
  <!-- DESCRIPCION -->
  <section id="collection" class="d-flex align-items-center bg-light">
    <div class="container">
      <div class="row">
        <div class=" col-md-10 text-center">
          <div class="text-content">
            <div class="display-header">
              <h2>Los remix más PRO</h2>
              <p class="mx-auto">El número #1 en remixes! Del Perú para el mundo.</p>
            </div>
            <a href="{{ url('/store') }}" class="btn btn-primary btn-md text-uppercase mt-4">Compra Ahora</a>
          </div>
        </div>
      </div>
    </div>
    <img src="{{ asset('img/pngegg.png') }}" alt="" class="imgdes">
  </section>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4">
          <div class="quotation-mark">
            <img src="{{ asset('img/pp1.png') }}" class="quote text-primary" width="167" alt="">
          </div>
        </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="review-item col-md-11">
                  <blockquote class="fs-2">Impresionada con los productos que ofrecen. Desde simples pistas hasta horas de música y diversión, lo tienen todo. ¡La mejor tienda de remixes exclusivos!</blockquote>
              ...
              <div class="swiper-slide">
                <div class="review-item col-md-11">
                  <blockquote class="fs-2">Los remixes son fascinantes, y quiero ver qué puedo hacer con ellos. En un nivel más profundo, representan una forma en que la sociedad divierte a sus jóvenes.</blockquote>
                  <div class="author-detail">
              ...
              <div class="swiper-slide">
                <div class="review-item col-md-11">
                  <blockquote class="fs-2">Para un aficionado, a menudo la idea en la que es comprar un remix era muy ardua, pero con Tom Gasco es más atractiva que el propio remix.</blockquote>
                  <div class="author-detail">
  ...
  <section id="gallery" class="py-lg-7 bg-light">
    <div class="container-lg">
      <div class="row justify-content-center">
        <div class="display-header text-center position-relative">
          <h2 class="display-2 text-center">Nuestra Galeria</h2>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/1.jpg') }}" title="doll" class="image-link">
              <img src="{{ asset('img/1.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/2.jpg') }}" title="doll" class="image-link">
              <img src="{{ asset('img/2.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/3.jpg') }}" title="doll" class="image-link">
              <img src="{{ asset('img/3.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/4.jpg') }}" title="doll" class="image-link">
              <img src="{{ asset('img/4.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/5.jpg') }}" title="doll" class="image-link">
              <img src="{{ asset('img/5.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/6.jpg') }}" data-lightbox-gallery="gallery1" title="doll" class="image-link">
              <img src="{{ asset('img/6.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/7.jpg') }}" data-lightbox-gallery="gallery1" title="doll" class="image-link">
              <img src="{{ asset('img/7.jpeg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
        <div class="col-lg-3 col-md-6">
          <figure class="gallery-item text-center">
            <a href="{{ asset('img/8.jpg') }}" data-lightbox-gallery="gallery1" title="doll" class="image-link">
              <img src="{{ asset('img/8.jpg') }}" alt="gallery" class="img-fluid rounded-4">
            </a>
          </figure>
        </div>
      </div>
  ...
  <!-- KEYWORD - ENLACE A TIENDA -->

  <!-- BLOG -->
  <section id="latest-blog" class="bg-linear py-lg-7">
    <div class="container-lg">
      <div class="row justify-content-center">
        <div class="display-header text-center position-relative">
          <h2 class="display-2 text-center">Proximas fechas</h2>
        </div>
        <div class="row">
            ...
            <div class="card-item position-relative">
              <div class="card border-0 bg-transparent">
                <div class="card-image mb-3">
                  <img src="{{ asset('img/post-item1.jpg') }}" alt="post" class="img-fluid rounded-4">
                </div>
              </div>
              <div class="card-body p-3 d-flex justify-content-center">
                <div class="meta-date position-absolute bg-primary text-light text-center mx-auto px-3 py-2 rounded-5">
                  <span class="fw-bold fs-3">22</span> Feb
                </div>
                <h3 class="card-title  text-center">
                  <a href="{{ asset('img/single-post.html') }}" class="text-secondary">"ElectroGroove Night" en "Neon Beats" con DJ Thom Gasco. ¡Vive la magia de la música electrónica! 🎶✨ #NeonBeats#ThomGasco</a>
                </h3>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-3">
            <div class="card-item position-relative">
              <div class="card border-0 bg-transparent">
                <div class="card-image mb-3">
                  <img src="{{ asset('img/post-item2.jpg') }}" alt="post" class="img-fluid rounded-4">
                </div>
              </div>
              <div class="card-body p-3 d-flex justify-content-center">
                <div class="meta-date position-absolute bg-primary text-light text-center mx-auto px-3 py-2 rounded-5">
                  <span class="fw-bold fs-3">10</span> March
                </div>
                <h3 class="card-title  text-center">
                  <a href="single-post.html" class="text-secondary">Fiesta del año en "Galactic Rhythms" con DJ Thom Gasco en "StarSound Club". 🚀🎶 ¡Experiencia cósmica de música electrónica! #GalacticRhythms#ThomGasco#StarSoundClub</a>
                </h3>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 mb-3">
            <div class="card-item position-relative">
              <div class="card border-0 bg-transparent">
                <div class="card-image mb-3">
                  <img src="{{ asset('img/post-item3.jpg') }}" alt="post" class="img-fluid rounded-4">
                </div>
              </div>
              <div class="card-body p-3 d-flex justify-content-center">
                <div class="meta-date position-absolute bg-primary text-light text-center mx-auto px-3 py-2 rounded-5">
                  <span class="fw-bold fs-3">18</span> April
                </div>
                <h3 class="card-title  text-center">
                  <a href="single-post.html" class="text-secondary">Descubre la vibrante escena musical en "Pulse Fusion" junto al talentoso DJ Thom Gasco en la discoteca "Sonic Spectrum". 🌈🎧 ¡Sumérgete en la fusión de ritmos y energía incomparable! #PulseFusion #ThomGasco #SonicSpectrum</a>
                </h3>
              </div>
            </div>
          </div>
        ...
        <div class="text-center mt-3">
          <a href="blog-with-sidebar.html" class="btn btn-primary btn-md text-uppercase text-center">Más Noticias</a>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="footer-menu">
            ...
            <ul class="menu-list list-unstyled">
              <li class="menu-item pb-2">
                <a href="#intro" class="item-anchor">Inicio</a>
              </li>
              <li class="menu-item pb-2">
              ...
              <li class="menu-item pb-2">
                <a href="{{ url('/contact') }}" class="item-anchor">Contactanos</a>
              </li>
            </ul>
          </div>
        </div>
